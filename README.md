...
### Steps to install:
1. Download the github code from the repo >>git clone https://github.com/kannanshan/DistanceCalculator.git
...
2. Command to execute : >>java -jar target/distancecalculator.jar -d 100 -s 53.339428 -6.257664
